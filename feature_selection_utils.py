...
def calculate_features_target_correlation(data, features, target, method):
    """
    This function receives the pandas dataframe, the list of features, and a string that representing the name of the
    target column in data frame.
    ...
    :type method: string
    :param method: specisifes the method for finding the correlation coefficients and can be "Pearson" or "Cross-cor"
...
def pca_bacteria(data, n_components):
    """
    calculate Principal Components Analysis from data in a pandas dataframe and n_components represents the desire
